...
<section id="About">
      ...
      <div className="container px-5 py-10 mx-auto text-center dark:bg-gray-900 bg-back-lightMid lg:px-40 lg:w-5/6 rounded-3xl">
        ...
        <div className="flex flex-row mb-12 ">
          <img 
            className="outline-main w-full rounded-2xl"
            src="/visualizations/lowest_cour.png"
            alt="Lowest 10 courses by GPA"
          />

        <div className="lg:w-2/3 w-full ml-6 my-auto overflow-hidden text-left">
        ...
        <div className="flex flex-row space-x-2 w-full mx-auto">
          <img 
            className="outline-main w-1/2 rounded-2xl mx-2 my-2"
            src="/visualizations/lowest_sub.png"
            alt="Lowest 10 subjects by GPA"
          />
          <img 
            className="outline-main w-1/2 rounded-2xl my-2"
            src="/visualizations/highest_sub.png"
            alt="Highest 10 subjects by GPA"
          />
        </div>
        <div className="mt-2 lg:w-2/3 mx-auto mb-10">
